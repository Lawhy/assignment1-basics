...
def get_tokenizer(
    ...
    return BPETokenizer(vocab=vocab, merges=merges, special_tokens=special_tokens or [])
...
def run_train_bpe(
    ...
    **kwargs,
    ...
    tok = BPETokenizer.train(input_path=input_path, vocab_size=vocab_size, special_tokens=special_tokens, **kwargs)
